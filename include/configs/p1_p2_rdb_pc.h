...
/* controller 3, direct to uli, tgtid 2, Base address 8000 */
#define CONFIG_SYS_PCIE3_NAME		"PCIe SLOT"
#define CONFIG_SYS_PCIE3_MEM_VIRT	0x90000000
#ifdef CONFIG_PHYS_64BIT
#define CONFIG_SYS_PCIE3_MEM_BUS	0x90000000
#define CONFIG_SYS_PCIE3_MEM_PHYS	0xc10000000ull
#else
#define CONFIG_SYS_PCIE3_MEM_BUS	0x90000000
#define CONFIG_SYS_PCIE3_MEM_PHYS	0x90000000
#endif
